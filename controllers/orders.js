...
exports.placeOrder = async (req, res, next) => {
  try {
    ...
    if (cartProducts.length > 0) {
      ...
      order.products = req.body.products; // JSON.parse
    }
      ...
      newOrder
        ...
        .then(async order => {
          ...
          for (item of order.products){
            ...
            const productQuantity = product.quantity; // to be update
            await Product.findOneAndUpdate({ _id: id }, { quantity: 10 }, { new: true })
